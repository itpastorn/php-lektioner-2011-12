<?php
/**
 * Visa ett blogginlägg vald via GET
 *
 * inlagg.php
 */

// Utgå från db_connect.php
...
// 2. Läs in, testa och "tvätta" användarens indata
if ( empty($_GET['blogg']) ) {
    // användaren har glömt att välja inlägg
    $errortext = "Du måste välja ett inlägg.";
} else {
    $id = (int)$_GET['blogg']; // Alltid heltal
